...
class AgentDetailsContent extends StatefulWidget {
  const AgentDetailsContent({super.key});

  @override
  State<AgentDetailsContent> createState() => _AgentDetailsContentState();
}

class _AgentDetailsContentState extends State<AgentDetailsContent>
