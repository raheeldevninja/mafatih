...
class PropertyRequestsResponse {
  int? status;
  String? message;
  List<PropertyRequestsProperties>? properties;

  PropertyRequestsResponse({this.status, this.message, this.properties});

  PropertyRequestsResponse.fromJson(Map<String, dynamic> json) {
    status = json['status'];
